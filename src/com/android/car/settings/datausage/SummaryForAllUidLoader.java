...
public class SummaryForAllUidLoader extends AsyncTaskLoader<NetworkStats> {
    ...
    public NetworkStats loadInBackground() {
        ...
        try {
            final NetworkStatsManager statsManager = (NetworkStatsManager)
                    getContext().getSystemService(Context.NETWORK_STATS_SERVICE);
            return statsManager.querySummary(template, start, end);
