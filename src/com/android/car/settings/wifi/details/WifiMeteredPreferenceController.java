...
public class WifiMeteredPreferenceController extends
	...
	if (wifiEntry.canSetMeteredChoice()) {
            ...
            LOG.w("Can't set metered choice, hidding meteredOption");
	    setAvailabilityStatusForZone("hidden");
	    refreshUi();
	}
    }
   ...
   protected boolean handlePreferenceChanged(ListPreference preference, Object newValue) {
        ...
        if (wifiEntry.canSetMeteredChoice()) {
            /*
	     * If canSetMeteredChoice() is false, metered
	     * choice will be set to hidden in updateState()
	     */
